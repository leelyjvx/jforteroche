...
<header>
	<nav class="navbar navbar-expand-sm navbar-light">
		<a class="navbar-brand" href="#"><img src="assets/pictures/mini.png" height="30" width="30" alt="logo" class="d-inline-block align-top"> BSPA</a>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav mx-auto">
				<li class="nav-item">
					<a class="nav-link" href="index.php?page=intro"> Menu </a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index.php?page=chapters"> Chapitres </a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index.php?page=author"> L'auteur </a>
				</li>
				<li class="nav-item"> 
